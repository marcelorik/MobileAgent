		...
		try {   
            ...
            while(e.hasMoreElements())
            {
                ...
                while(ee.hasMoreElements())
                {
					...
					if(i.getHostAddress().indexOf(".")==3) {
						System.out.println("//"+i.getHostAddress()+"/"+agencia.getName()+"\n");
						if(Naming.lookup("//"+i.getHostAddress()+"/"+agencia.getName())!=null) {
							//AgenciaI nextAgencia = null;  
							nextAgencia = (AgenciaI) Naming.lookup("//"+i.getHostAddress()+"/"+agencia.getName());
							nextAgencia.isAlive();
							if(nextAgencia.isAlive()==1)
			...
			nextAgencia = (AgenciaI) Naming.lookup("//192.168.1.5/"+agencia.getName());
				
				//if(nextAgencia!=null)
				//nextAgencia.isAlive();
			
			System.out.println(nextAgencia.toString());			
